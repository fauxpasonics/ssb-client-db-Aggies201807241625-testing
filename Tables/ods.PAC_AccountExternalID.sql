CREATE TABLE [ods].[PAC_AccountExternalID]
(
...
[ExternalID] [nvarchar] (256) COLLATE SQL_Latin1_General_CP1_CS_AS NULL,
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_ods__PAC_AccountExternalID] ON [ods].[PAC_AccountExternalID]
GO
