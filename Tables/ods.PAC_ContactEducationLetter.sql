CREATE TABLE [ods].[PAC_ContactEducationLetter]
(
...
[LetterYear] [int] NULL,
[Sport] [nvarchar] (256) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_ods__PAC_ContactEducationLetter] ON [ods].[PAC_ContactEducationLetter]
GO
