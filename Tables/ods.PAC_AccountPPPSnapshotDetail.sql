CREATE TABLE [ods].[PAC_AccountPPPSnapshotDetail]
(
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_ods__PAC_AccountPPPSnapshotDetail] ON [ods].[PAC_AccountPPPSnapshotDetail]
GO
