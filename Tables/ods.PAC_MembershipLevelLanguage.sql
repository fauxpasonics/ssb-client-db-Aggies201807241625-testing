CREATE TABLE [ods].[PAC_MembershipLevelLanguage]
(
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_ods__PAC_MembershipLevelLanguage] ON [ods].[PAC_MembershipLevelLanguage]
GO
