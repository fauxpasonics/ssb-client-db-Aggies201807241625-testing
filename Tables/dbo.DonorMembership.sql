CREATE TABLE [dbo].[DonorMembership]
(
...
[PledgedLevelName] [nvarchar] (256) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ReceiptedLevelName] [nvarchar] (256) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[TotalDonationAmount] [money] NULL,
[TotalPledgeAmount] [money] NULL,
...
GO
ALTER TABLE [dbo].[DonorMembership] ADD CONSTRAINT [PK_dbo_DonorMembership] PRIMARY KEY CLUSTERED  ([OrganizationID], [AccountDbID], [AccountID], [MembershipID], [DriveYear])
GO
