CREATE TABLE [ods].[PAC_AllocationGroupLanguage]
(
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_ods__PAC_AllocationGroupLanguage] ON [ods].[PAC_AllocationGroupLanguage]
GO
