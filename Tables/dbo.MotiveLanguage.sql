CREATE TABLE [dbo].[MotiveLanguage]
(
[OrganizationID] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL,
[MotiveID] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL,
...
GO
ALTER TABLE [dbo].[MotiveLanguage] ADD CONSTRAINT [PK_dbo_MotiveLanguage] PRIMARY KEY CLUSTERED  ([OrganizationID], [MotiveID], [LanguageCode])
GO
CREATE NONCLUSTERED INDEX [IX_dbo_MotiveLanguage_LanguageCode] ON [dbo].[MotiveLanguage] ([LanguageCode])
GO
