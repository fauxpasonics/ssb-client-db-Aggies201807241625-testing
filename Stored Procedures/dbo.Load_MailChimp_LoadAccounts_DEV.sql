...
CREATE PROC [dbo].[Load_MailChimp_LoadAccounts_DEV] AS 
...
CREATE NONCLUSTERED INDEX IX_AccountNumber on #LoadAccounts (AccountNumber)
CREATE NONCLUSTERED INDEX IX_email on #LoadAccounts (email)
...
FROM #production prod
	LEFT JOIN #LoadAccounts la on la.AccountNumber = prod.AccountNumber
