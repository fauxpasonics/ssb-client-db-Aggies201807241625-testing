CREATE TABLE [ods].[PAC_AccountTag]
(
...
[Tag] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_ods__PAC_AccountTag] ON [ods].[PAC_AccountTag]
GO
