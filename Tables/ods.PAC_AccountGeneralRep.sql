CREATE TABLE [ods].[PAC_AccountGeneralRep]
(
...
[GeneralRepUserID] [bigint] NOT NULL,
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_ods__PAC_AccountGeneralRep] ON [ods].[PAC_AccountGeneralRep]
GO
