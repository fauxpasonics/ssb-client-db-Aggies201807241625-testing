CREATE TABLE [amy].[seatdetail_flat]
(
...
GO
CREATE NONCLUSTERED INDEX [seatdetail_flat_accountnumber_tixeventlookupid] ON [amy].[seatdetail_flat] ([accountnumber], [tixeventlookupid])
GO
CREATE NONCLUSTERED INDEX [idx_Nonclustered_seatdetail_flat_seatsection] ON [amy].[seatdetail_flat] ([seatsection]) INCLUDE ([accountnumber], [seatrow])
GO
CREATE NONCLUSTERED INDEX [idx_Nonclustered_seatdetail_flat_tixeventlookupid] ON [amy].[seatdetail_flat] ([tixeventlookupid]) INCLUDE ([accountnumber], [qty], [seatpricecode], [seatrow], [seatsection])
GO
