CREATE TABLE [ods].[PAC_ContactAttribute]
(
...
[AttributeCodeDbID] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL,
[AttributeCodeType] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL,
[AttributeCodeSubtype] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL,
[AttributeCode] [nvarchar] (64) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL,
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_ods__PAC_ContactAttribute] ON [ods].[PAC_ContactAttribute]
GO
