CREATE TABLE [ods].[PAC_PPPCombinedCategoryLanguage]
(
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_ods__PAC_PPPCombinedCategoryLanguage] ON [ods].[PAC_PPPCombinedCategoryLanguage]
GO
