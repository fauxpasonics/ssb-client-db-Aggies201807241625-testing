CREATE TABLE [ods].[PAC_UDFDefinitionList]
(
...
[KeyValue] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[Value] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_ods__PAC_UDFDefinitionList] ON [ods].[PAC_UDFDefinitionList]
GO
