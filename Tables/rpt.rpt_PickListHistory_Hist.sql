CREATE TABLE [rpt].[rpt_PickListHistory_Hist]
(
...
GO
CREATE NONCLUSTERED INDEX [idx_PickList_rpt] ON [rpt].[rpt_PickListHistory_Hist] ([tixeventid], [accountnumber])
GO
ALTER INDEX [idx_PickList_rpt] ON [rpt].[rpt_PickListHistory_Hist] DISABLE
GO
