CREATE TABLE [ods].[PAC_SpecialEventAILanguage]
(
[OrganizationID] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL,
[SpecialEventAIID] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL,
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_ods__PAC_SpecialEventAILanguage] ON [ods].[PAC_SpecialEventAILanguage]
GO
