CREATE TABLE [ods].[PAC_AccountPPPDetailLanguage]
(
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_ods__PAC_AccountPPPDetailLanguage] ON [ods].[PAC_AccountPPPDetailLanguage]
GO
