...
-- Author:       
-- Create date: 
-- Description:  Lists Databases users and 
-- associated roles
-- =============================================
CREATE PROCEDURE [dba].[usp_DBUsersandRoles]
...
WHERE dp.sid NOT IN (0x01) AND dp.sid IS NOT NULL AND dp.type NOT IN (''C'') AND dp.is_fixed_role <> 1 AND dp.name NOT LIKE ''##%'' AND 
