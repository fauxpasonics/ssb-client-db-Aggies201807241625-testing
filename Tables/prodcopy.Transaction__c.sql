...
[Seat_Block__c] [ntext] COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[Current_Fiscal_Months_Trans__c] [nvarchar] (1300) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Is_Trans_Current__c] [bit] NULL,
[Sort_Month__c] [nvarchar] (1300) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Transaction_Month__c] [nvarchar] (1300) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[copyloaddate] [datetime] NULL,
[ETL_Sync_DeltaHashKey] [binary] (32) NULL
)
GO
ALTER TABLE [prodcopy].[Transaction__c] ADD CONSTRAINT [PK__Transact__3214EC07C3FE019A] PRIMARY KEY CLUSTERED  ([Id])
GO
