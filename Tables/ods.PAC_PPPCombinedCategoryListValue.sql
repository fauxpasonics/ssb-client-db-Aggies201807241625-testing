CREATE TABLE [ods].[PAC_PPPCombinedCategoryListValue]
(
...
[PPPCombinedCategorySequence] [int] NOT NULL,
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_ods__PAC_PPPCombinedCategoryListValue] ON [ods].[PAC_PPPCombinedCategoryListValue]
GO
