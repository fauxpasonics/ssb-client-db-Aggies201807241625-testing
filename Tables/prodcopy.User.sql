...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__User__copyloadda__5BD88551] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[User] ADD CONSTRAINT [PK__User__3214EC071E76799C] PRIMARY KEY CLUSTERED  ([Id])
GO
