...
GO
ALTER TABLE [email].[DimEmail] WITH NOCHECK ADD CONSTRAINT [FK_DimEmail_DimEmailStatusID] FOREIGN KEY ([DimEmailStatusID]) REFERENCES [email].[DimEmailStatus] ([DimEmailStatusID])
GO
ALTER TABLE [email].[DimEmail] NOCHECK CONSTRAINT [FK_DimEmail_DimEmailStatusID]
GO
