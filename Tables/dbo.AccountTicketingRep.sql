CREATE TABLE [dbo].[AccountTicketingRep]
(
...
[TicketingRepUserID] [bigint] NOT NULL,
...
GO
ALTER TABLE [dbo].[AccountTicketingRep] ADD CONSTRAINT [PK_dbo_AccountTicketingRep] PRIMARY KEY CLUSTERED  ([AccountDbID], [AccountID], [Sequence], [TicketingRepUserID])
GO
