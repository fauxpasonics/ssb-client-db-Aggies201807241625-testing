...
GO
	...
	END
GO
DISABLE TRIGGER [dbo].[isdeleted_updated] ON [dbo].[DimCustomer]
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_NULLS ON
GO
	...
	END
GO
DISABLE TRIGGER [dbo].[matchkey_updated] ON [dbo].[DimCustomer]
GO
...
GO
CREATE NONCLUSTERED INDEX [nci_wi_DimCustomer_40F734DB04D91FC607540397D812969F] ON [dbo].[DimCustomer] ([IsDeleted]) INCLUDE ([AddressFourIsCleanStatus], [AddressOneIsCleanStatus], [AddressPrimaryIsCleanStatus], [AddressThreeIsCleanStatus], [AddressTwoIsCleanStatus], [EmailOneIsCleanStatus], [EmailPrimaryIsCleanStatus], [EmailTwoIsCleanStatus], [NameIsCleanStatus])
GO
...
GO
CREATE NONCLUSTERED INDEX [nci_wi_DimCustomer_FBC699E9F6064307ED467DC3B90B503A] ON [dbo].[DimCustomer] ([IsDeleted], [NameIsCleanStatus]) INCLUDE ([AddressPrimaryCity], [AddressPrimaryPlus4], [AddressPrimaryState], [AddressPrimaryStreet], [AddressPrimarySuite], [AddressPrimaryZip], [CompanyName], [ContactGUID], [customer_matchkey], [EmailPrimary], [FirstName], [LastName], [SourceSystem], [SSID], [Suffix])
GO
