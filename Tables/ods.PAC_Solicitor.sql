CREATE TABLE [ods].[PAC_Solicitor]
(
...
[SolicitorTeamID] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CS_AS NULL,
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_ods__PAC_Solicitor] ON [ods].[PAC_Solicitor]
GO
