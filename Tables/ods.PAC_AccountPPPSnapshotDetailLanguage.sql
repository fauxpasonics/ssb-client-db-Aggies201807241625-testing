CREATE TABLE [ods].[PAC_AccountPPPSnapshotDetailLanguage]
(
...
[LanguageCode] [nvarchar] (256) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL,
[PPPCategoryName] [nvarchar] (256) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_ods__PAC_AccountPPPSnapshotDetailLanguage] ON [ods].[PAC_AccountPPPSnapshotDetailLanguage]
GO
