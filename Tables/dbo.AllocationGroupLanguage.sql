CREATE TABLE [dbo].[AllocationGroupLanguage]
(
[OrganizationID] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL,
[AllocationGroupID] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL,
...
GO
ALTER TABLE [dbo].[AllocationGroupLanguage] ADD CONSTRAINT [PK_dbo_AllocationGroupLanguage] PRIMARY KEY CLUSTERED  ([OrganizationID], [AllocationGroupID], [LanguageCode])
GO
CREATE NONCLUSTERED INDEX [IX_dbo_AllocationGroupLanguage_LanguageCode] ON [dbo].[AllocationGroupLanguage] ([LanguageCode])
GO
