CREATE TABLE [ods].[VTXtixeventzoneseats_err]
(
...
[tixeventid] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[tixeventzoneid] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [ods].[VTXtixeventzoneseats_err] ADD CONSTRAINT [PK__VTXtixev__7EF6BFCDA7C55041] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
