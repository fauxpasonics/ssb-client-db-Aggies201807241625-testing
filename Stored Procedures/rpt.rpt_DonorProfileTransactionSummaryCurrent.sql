...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [rpt].[rpt_DonorProfileTransactionSummaryCurrent] (@ADNumber INT)
...
--(ticketing information should come from veritex)
--currentyear/CAP
SELECT 
	programname
	,b.TransYear
...
(
	...
	WHERE transyear IN (@CurrentYear, 'CAP')
