...
[CREDIT_STATUS] [varchar] (10) COLLATE SQL_Latin1_General_CP1_CS_AS NULL,
[CREDIT_COMMENTS] [varchar] (4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
CREATE NONCLUSTERED INDEX [IDX_ETLSID] ON [dbo].[TK_CUSTOMER] ([ETLSID])
GO
