...
GO
ALTER TABLE [dbo].[DimCustomerAttributeValues] WITH NOCHECK ADD CONSTRAINT [FK_DimCustomerAttrID] FOREIGN KEY ([DimCustomerAttrID]) REFERENCES [dbo].[DimCustomerAttributes] ([DimCustomerAttrID])
GO
ALTER TABLE [dbo].[DimCustomerAttributeValues] NOCHECK CONSTRAINT [FK_DimCustomerAttrID]
GO
