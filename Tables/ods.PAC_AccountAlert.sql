CREATE TABLE [ods].[PAC_AccountAlert]
(
...
[AlertCodeDbID] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL,
[AlertCodeType] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL,
[AlertCodeSubtype] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL,
[AlertCode] [nvarchar] (64) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL,
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_ods__PAC_AccountAlert] ON [ods].[PAC_AccountAlert]
GO
