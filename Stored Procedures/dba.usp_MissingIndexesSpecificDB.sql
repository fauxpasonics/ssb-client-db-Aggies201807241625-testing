...
-- Author:        SSB
-- Create date:   
-- Description:   usp_MissingIndexesForOneDB
--     Copy the select staemnt and run for each DB          
-- =============================================
 
CREATE PROCEDURE  [dba].[usp_MissingIndexesSpecificDB] 
AS  
SELECT
    ...
    , CASE [sObj].[type]
       ...
       ELSE 'Unknown'
    END AS [ObjectType]
    , [sdmvMID].[equality_columns] AS [NeededColumnOrder]
    , [sdmvMID].[inequality_columns] AS [AddittionalColumns]
