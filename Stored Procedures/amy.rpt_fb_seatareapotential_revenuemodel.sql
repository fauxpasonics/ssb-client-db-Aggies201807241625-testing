...
SET ANSI_NULLS ON
GO
CREATE procedure [amy].[rpt_fb_seatareapotential_revenuemodel] (@ticketyear  int)
 AS
...
WHERE 1=1 
  ...
  and isnull(rw.tixseatgroupdesc,'') not in ( 'SRO','Suite Member','ADMIN') 
...
seatareaname, seatareaid , premium_ind
 ...
 ) fmsum group by fundingreportid  --,ticketpriceperseat,  annualperticket
 ) dtl ,
