CREATE TABLE [ods].[PAC_MembershipLevelBenefit]
(
...
[BenefitItemID] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL,
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_ods__PAC_MembershipLevelBenefit] ON [ods].[PAC_MembershipLevelBenefit]
GO
