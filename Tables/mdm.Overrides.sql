...
GO
DISABLE TRIGGER [mdm].[trg_Overrides_Update_Insert] ON [mdm].[Overrides]
GO
...
GO
ALTER TABLE [mdm].[Overrides] WITH NOCHECK ADD CONSTRAINT [FK_Overrides_DimCustomerID] FOREIGN KEY ([DimCustomerID]) REFERENCES [dbo].[DimCustomer] ([DimCustomerId])
GO
ALTER TABLE [mdm].[Overrides] NOCHECK CONSTRAINT [FK_Overrides_DimCustomerID]
GO
