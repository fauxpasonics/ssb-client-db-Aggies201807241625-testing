...
GO
CREATE NONCLUSTERED INDEX [IDX_ETLSID] ON [dbo].[TK_ODET_EVENT_SBLS] ([ETLSID])
GO
CREATE NONCLUSTERED INDEX [nci_wi_TK_ODET_EVENT_SBLS_BDBDEFD9714349453FF2887299910F4F] ON [dbo].[TK_ODET_EVENT_SBLS] ([EVENT], [ITEM], [SEASON]) INCLUDE ([FIRST_SEAT], [LAST_SEAT], [LEVEL], [ROW], [SECTION])
GO
CREATE NONCLUSTERED INDEX [IDX_SEASON] ON [dbo].[TK_ODET_EVENT_SBLS] ([SEASON])
GO
CREATE NONCLUSTERED INDEX [IDX_SEQ] ON [dbo].[TK_ODET_EVENT_SBLS] ([SEQ])
GO
