...
[DimEmailID] [int] NULL,
[CreatedDate] [datetime] NULL CONSTRAINT [DF__Source_Di__Creat__1ECF7711] DEFAULT (getdate()),
[CreatedBy] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[UpdatedDate] [datetime] NULL CONSTRAINT [DF__Source_Di__Updat__1FC39B4A] DEFAULT (getdate()),
...
GO
ALTER TABLE [email].[Source_DimEmail] WITH NOCHECK ADD CONSTRAINT [FK_Source_DimEmail_DimEmailID] FOREIGN KEY ([DimEmailID]) REFERENCES [email].[DimEmail] ([DimEmailID])
GO
ALTER TABLE [email].[Source_DimEmail] NOCHECK CONSTRAINT [FK_Source_DimEmail_DimEmailID]
GO
