...
GO
ALTER INDEX [IX_DimPhone_Phone] ON [dbo].[DimPhone] DISABLE
GO
CREATE NONCLUSTERED INDEX [IX_DimPhone_PhoneCleanHash] ON [dbo].[DimPhone] ([PhoneCleanHash])
GO
ALTER INDEX [IX_DimPhone_PhoneCleanHash] ON [dbo].[DimPhone] DISABLE
GO
CREATE NONCLUSTERED INDEX [IX_DimPhone_PhoneLineTypeCode] ON [dbo].[DimPhone] ([PhoneLineTypeCode])
GO
ALTER INDEX [IX_DimPhone_PhoneLineTypeCode] ON [dbo].[DimPhone] DISABLE
GO
ALTER TABLE [dbo].[DimPhone] WITH NOCHECK ADD CONSTRAINT [FK_DimPhone_PhoneLineTypeCode] FOREIGN KEY ([PhoneLineTypeCode]) REFERENCES [dbo].[PhoneLineTypeCode] ([PhoneLineTypeCode])
GO
ALTER TABLE [dbo].[DimPhone] NOCHECK CONSTRAINT [FK_DimPhone_PhoneLineTypeCode]
GO
