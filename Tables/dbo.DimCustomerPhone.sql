...
GO
ALTER TABLE [dbo].[DimCustomerPhone] WITH NOCHECK ADD CONSTRAINT [FK_DimCustomerPhone_DimPhoneID] FOREIGN KEY ([DimPhoneID]) REFERENCES [dbo].[DimPhone] ([DimPhoneID])
GO
ALTER TABLE [dbo].[DimCustomerPhone] WITH NOCHECK ADD CONSTRAINT [FK_DimCustomerPhone_Source_DimPhoneID] FOREIGN KEY ([Source_DimPhoneID]) REFERENCES [dbo].[Source_DimPhone] ([Source_DimPhoneID])
GO
ALTER TABLE [dbo].[DimCustomerPhone] NOCHECK CONSTRAINT [FK_DimCustomerPhone_DimPhoneID]
GO
ALTER TABLE [dbo].[DimCustomerPhone] NOCHECK CONSTRAINT [FK_DimCustomerPhone_Source_DimPhoneID]
GO
