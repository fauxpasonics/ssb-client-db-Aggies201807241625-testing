CREATE TABLE [dbo].[SourceLanguage]
(
[OrganizationID] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL,
[SourceID] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL,
...
GO
ALTER TABLE [dbo].[SourceLanguage] ADD CONSTRAINT [PK_dbo_SourceLanguage] PRIMARY KEY CLUSTERED  ([OrganizationID], [SourceID], [LanguageCode])
GO
CREATE NONCLUSTERED INDEX [IX_dbo_SourceLanguage_LanguageCode] ON [dbo].[SourceLanguage] ([LanguageCode])
GO
