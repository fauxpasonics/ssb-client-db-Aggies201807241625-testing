CREATE TABLE [dbo].[ChannelLanguage]
(
...
GO
ALTER TABLE [dbo].[ChannelLanguage] ADD CONSTRAINT [PK_dbo_ChannelLanguage] PRIMARY KEY CLUSTERED  ([ChannelID], [LanguageCode])
GO
CREATE NONCLUSTERED INDEX [IX_dbo_ChannelLanguage_LanguageCode] ON [dbo].[ChannelLanguage] ([LanguageCode])
GO
