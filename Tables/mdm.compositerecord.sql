...
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_AddressFourIsCleanStatus] ON [mdm].[compositerecord] ([SSB_CRMSYSTEM_CONTACT_ID]) INCLUDE ([AddressFourIsCleanStatus])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_AddressOneIsCleanStatus] ON [mdm].[compositerecord] ([SSB_CRMSYSTEM_CONTACT_ID]) INCLUDE ([AddressOneIsCleanStatus])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_AddressPrimaryIsCleanStatus] ON [mdm].[compositerecord] ([SSB_CRMSYSTEM_CONTACT_ID]) INCLUDE ([AddressPrimaryIsCleanStatus])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_AddressThreeIsCleanStatus] ON [mdm].[compositerecord] ([SSB_CRMSYSTEM_CONTACT_ID]) INCLUDE ([AddressThreeIsCleanStatus])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_AddressTwoIsCleanStatus] ON [mdm].[compositerecord] ([SSB_CRMSYSTEM_CONTACT_ID]) INCLUDE ([AddressTwoIsCleanStatus])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_EmailOneIsCleanStatus] ON [mdm].[compositerecord] ([SSB_CRMSYSTEM_CONTACT_ID]) INCLUDE ([EmailOneIsCleanStatus])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_EmailPrimaryIsCleanStatus] ON [mdm].[compositerecord] ([SSB_CRMSYSTEM_CONTACT_ID]) INCLUDE ([EmailPrimaryIsCleanStatus])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_EmailTwoIsCleanStatus] ON [mdm].[compositerecord] ([SSB_CRMSYSTEM_CONTACT_ID]) INCLUDE ([EmailTwoIsCleanStatus])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_PhoneBusinessIsCleanStatus] ON [mdm].[compositerecord] ([SSB_CRMSYSTEM_CONTACT_ID]) INCLUDE ([PhoneBusinessIsCleanStatus])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_PhoneCellIsCleanStatus] ON [mdm].[compositerecord] ([SSB_CRMSYSTEM_CONTACT_ID]) INCLUDE ([PhoneCellIsCleanStatus])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_PhoneFaxIsCleanStatus] ON [mdm].[compositerecord] ([SSB_CRMSYSTEM_CONTACT_ID]) INCLUDE ([PhoneFaxIsCleanStatus])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_PhoneHomeIsCleanStatus] ON [mdm].[compositerecord] ([SSB_CRMSYSTEM_CONTACT_ID]) INCLUDE ([PhoneHomeIsCleanStatus])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_PhoneOtherIsCleanStatus] ON [mdm].[compositerecord] ([SSB_CRMSYSTEM_CONTACT_ID]) INCLUDE ([PhoneOtherIsCleanStatus])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecords_PhonePrimaryIsCleanStatus] ON [mdm].[compositerecord] ([SSB_CRMSYSTEM_CONTACT_ID]) INCLUDE ([PhonePrimaryIsCleanStatus])
GO
CREATE NONCLUSTERED INDEX [IDX_mdmCompositeRecords_UpdatedDate_ACCTCONTACTIDs] ON [mdm].[compositerecord] ([UpdatedDate]) INCLUDE ([SSB_CRMSYSTEM_ACCT_ID], [SSB_CRMSYSTEM_CONTACT_ID], [SSB_CRMSYSTEM_HOUSEHOLD_ID])
GO
