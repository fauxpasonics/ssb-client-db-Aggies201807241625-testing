CREATE TABLE [ods].[PAC_AccountKeyword]
(
...
[Keyword] [nvarchar] (512) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_ods__PAC_AccountKeyword] ON [ods].[PAC_AccountKeyword]
GO
