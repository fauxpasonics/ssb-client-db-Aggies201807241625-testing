CREATE TABLE [ods].[PAC_SpecialEventItem]
(
...
[SpecialEventItemID] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL,
[AllocationID] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CS_AS NULL,
[AttendeeQuantity] [bigint] NULL,
[ItemName] [nvarchar] (256) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Sequence] [int] NULL,
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_ods__PAC_SpecialEventItem] ON [ods].[PAC_SpecialEventItem]
GO
