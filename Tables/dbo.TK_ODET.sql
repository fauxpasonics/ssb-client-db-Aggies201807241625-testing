...
[ORIG_ITEM] [varchar] (65) COLLATE SQL_Latin1_General_CP1_CS_AS NULL,
[INTERNET_SOURCE] [varchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
CREATE NONCLUSTERED INDEX [IDX_ETLSID] ON [dbo].[TK_ODET] ([ETLSID])
GO
