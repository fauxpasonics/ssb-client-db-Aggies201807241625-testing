...
GO
CREATE NONCLUSTERED INDEX [IDX_ETLSID] ON [dbo].[TK_ODET_EVENT_ASSOC] ([ETLSID])
GO
...
GO
CREATE NONCLUSTERED INDEX [IDX_SEQ] ON [dbo].[TK_ODET_EVENT_ASSOC] ([SEQ])
GO
CREATE NONCLUSTERED INDEX [IDX_ZID] ON [dbo].[TK_ODET_EVENT_ASSOC] ([ZID])
GO
