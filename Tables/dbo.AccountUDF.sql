...
[UDFValue] [nvarchar] (999) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[AccountUDF] ADD CONSTRAINT [PK_dbo_AccountUDF] PRIMARY KEY CLUSTERED  ([AccountDbID], [AccountID], [UDFTypeCode], [UDFDefinitionID])
GO
CREATE NONCLUSTERED INDEX [idx_dbovAccountUDF_UDFDefinitionID] ON [dbo].[AccountUDF] ([UDFDefinitionID])
GO
