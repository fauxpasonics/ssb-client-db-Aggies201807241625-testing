...
CREATE  PROCEDURE [amy].[rpt_DonorNewGradMembershipReportGrid_n] (@startdate date = '01/01/2015',  @enddate date = '12/31/2015')
...
LEFT JOIN
 ...
 WHERE 
donorstatuscode not in ('NB','D')    and donortypecode  = 'NG'                                                     
)       AS t
 WHERE 
