CREATE TABLE [ods].[PAC_MembershipContributingAllocation]
(
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_ods__PAC_MembershipContributingAllocation] ON [ods].[PAC_MembershipContributingAllocation]
GO
