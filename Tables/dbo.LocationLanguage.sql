CREATE TABLE [dbo].[LocationLanguage]
(
...
GO
ALTER TABLE [dbo].[LocationLanguage] ADD CONSTRAINT [PK_dbo_LocationLanguage] PRIMARY KEY CLUSTERED  ([LocationID], [LanguageCode])
GO
CREATE NONCLUSTERED INDEX [IX_dbo_LocationLanguage_LanguageCode] ON [dbo].[LocationLanguage] ([LanguageCode])
GO
