CREATE TABLE [amy].[RPT_SEATREGION_TB]
(
...
GO
CREATE NONCLUSTERED INDEX [rpt_seatregion_tb_ind_sportid_ticketyear] ON [amy].[RPT_SEATREGION_TB] ([Sporttype], [Ticketyear])
GO
CREATE NONCLUSTERED INDEX [rpt_seatregion_tb_ind_sportid_ticketyear_adnumber] ON [amy].[RPT_SEATREGION_TB] ([Sporttype], [Ticketyear], [adnumber], [accountname])
GO
